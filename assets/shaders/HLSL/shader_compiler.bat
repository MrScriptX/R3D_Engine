...
F:\Programs\VulkanSDK\1.2.170.0\Bin32\glslangValidator.exe -V normalmap.vert
...
F:\Programs\VulkanSDK\1.2.170.0\Bin32\glslangValidator.exe -V light_source.frag
pause
F:\Programs\VulkanSDK\1.2.170.0\Bin32\glslc.exe shader.vert -o ../vert.spv
F:\Programs\VulkanSDK\1.2.170.0\Bin32\glslc.exe normalmap.vert -o ../normalmap.spv
...
F:\Programs\VulkanSDK\1.2.170.0\Bin32\glslc.exe light_source.frag -o ../light_source.spv