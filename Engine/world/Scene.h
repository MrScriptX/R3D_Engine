...
class Scene
{
  public:
	...
	R3DResult AddLight(std::shared_ptr<SpotLight> light);
	R3DResult RemoveLight(std::shared_ptr<DirectionalLight> light);
	R3DResult RemoveLight(std::shared_ptr<PointLight> light);
  ...
  private:
	...
	R3DResult addSpotLight(std::shared_ptr<SpotLight> lightobject);
	R3DResult addPointLight(std::shared_ptr<PointLight> light);
	R3DResult removeDirectionalLight(std::shared_ptr<DirectionalLight> lightobject);
	R3DResult removeSpotLight(std::shared_ptr<SpotLight> lightobject);
	R3DResult removePointLight(std::shared_ptr<PointLight> lightobject);
	...
	// light
	std::array<std::shared_ptr<DirectionalLight>, MAX_LIGHT> vp_directional_lights;
	std::array<std::shared_ptr<SpotLight>, MAX_LIGHT> vp_spot_lights;
	std::array<std::shared_ptr<PointLight>, MAX_LIGHT> vp_point_lights;
